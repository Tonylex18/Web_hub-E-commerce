<?php 
    ...
    function add_product () {
        ...
        if (isset($_POST['add_product'])) {
            ...
            move_uploaded_file($pro_img1_tmp, "../img/pro_imgs/$pro_img1");
            move_uploaded_file($pro_img2_tmp, "../img/pro_imgs/$pro_img2");
            move_uploaded_file($pro_img3_tmp, "../img/pro_imgs/$pro_img3");
            move_uploaded_file($pro_img4_tmp, "../img/pro_imgs/$pro_img4");
        ...
        $pro_for_whome = $_POST['for_whome'];
            ...
            $add_cat = $con -> prepare ("insert into product
                                        (
    ...
    function viewall_category () {
        ...
        while ($row = $fetch_cat -> fetch()) :
            echo"<tr>
                    <td>".$i++."</td>
                    <td>".$row['cat_name']."</td>
                    <td><a href='index.php?edit_cat=".$row['cat_id']."'>Edith</td></td>
                    <td><a href='delete_cat.php?delete_cat=".$row['cat_id']."'>Delete</td></td>
                </tr>";
        endwhile;
    }
    ...
    function viewall_sub_category () {
        ...
        while ($row = $fetch_cat -> fetch()) :
            echo"<tr>
                    ...
                    <td><a href='index.php?edit_sub_cat=".$row['sub_cat_id']."'>Edith</td></td>
                    <td><a href='delete_cat.php?delete_sub_cat=".$row['sub_cat_id']."'>Delete</td></td>
                </tr>";
        endwhile;
    }
    ...
    $fetch_pro = $con->prepare("select * from product ORDER BY 1 DESC");
        ...
        while ($row = $fetch_pro -> fetch()) :
            echo"<tr>
                    <td>".$i++."</td>
                    <td><a href='index.php?edit_pro=".$row['pro_id']."'>Edith</td></td>
                    <td><a href='delete_cat.php?delete_pro=".$row['pro_id']."'>Delete</td></td>
                    <td  style='min-width: 200px;'>".$row['pro_name']."</td>
                    <td style='min-width: 200px;'>
                        <img src='../img/pro_imgs/".$row['pro_img1']."' />
                        <img src='../img/pro_imgs/".$row['pro_img2']."' />
                        <img src='../img/pro_imgs/".$row['pro_img3']."' />
                        <img src='../img/pro_imgs/".$row['pro_img4']."' />
                    </td>
   ...
   function edit_pro() {
        ...
        echo"<form method='post' enctype='multipart/form-data'>
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <img src='../img/pro_imgs/".$row['pro_img1']." ' style='width: 60px; height: 60px;' />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <img src='../img/pro_imgs/".$row['pro_img2']." ' style='width: 60px; height: 60px;' />
                        </td>
                    </tr>
                    <tr>
                        <td>Update Product Image 3 : </td>
                         <td>
                            <input type='file' name='pro_im31'>
                            <img src='../img/pro_imgs/".$row['pro_img3']." ' style='width: 60px; height: 60px;' />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <img src='../img/pro_imgs/".$row['pro_img4']." ' style='width: 60px; height: 60px;' />
                        </td>
                    </tr>
                    <tr>
            ...
            if(isset($_POST['up_product'])) {
                    ...
                    $up_pro = $con -> prepare ("update product set pro_name='$pro_name', cat_id='$cat_id', sub_cat_id='$sub_cat_id',
                                            pro_img1='$pro_img1', pro_img2='$pro_img2', pro_img3='$pro_img3', pro_img4='$pro_img4',
                                            pro_feature1='$pro_feature1', pro_feature2='$pro_feature2', pro_feature3='$pro_feature3',
                                            pro_feature4='$pro_feature4', pro_feature5='$pro_feature5', pro_price='$pro_price', pro_model='$pro_model',
